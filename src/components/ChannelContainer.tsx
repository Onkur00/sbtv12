...
export const ChannelContainer: React.FC<ChannelContainerProps> = ({
  ...
  // Helper mapping of category IDs to display metadata dynamically generated
  const parsedCategoriesList = categoriesList
    ...
    .map((cat) => {
      ...
      if (norm.includes('sport')) { icon = Gamepad2; color = 'text-lime-400'; }
      else if (norm.includes('news')) { icon = Newspaper; color = 'text-sky-400'; }
      else if (norm.includes('kid') || norm.includes('cartoon')) { icon = Smile; color = 'text-pink-400'; }
      else if (norm.includes('bangla')) { icon = Compass; color = 'text-emerald-400'; }
      else if (norm.includes('hindi')) { icon = Tv; color = 'text-orange-400'; }
      else if (norm.includes('english')) { icon = Languages; color = 'text-violet-400'; }
      else if (norm.includes('sonatoni') || norm.includes('hindu')) { icon = Sunrise; color = 'text-amber-400'; }
      else if (norm.includes('islamic') || norm.includes('muslim')) { icon = Moon; color = 'text-teal-400'; }
      else if (norm.includes('youtube')) { icon = PlaySquare; color = 'text-red-400'; }
